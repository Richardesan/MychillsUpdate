...
<div>
      ...
      <section className="z-50">
        ...
        <p className='text-xl dm-sans-semibold max-sm:text-base'>Learn more</p>
        
    </div>
          
          </Link>
          <a href="https://docs.google.com/forms/d/e/1FAIpQLSesKDdcJTC0KLT3FAHDc9zUWNXE-9oXzFmtWgH11jElgKt0WQ/viewform" target="_blank" className="max-md:w-full z-20">
